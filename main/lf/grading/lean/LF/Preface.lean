...
--  your Lean installation. Alternatively, once you have added the Lean 4
--  extension to VS Code, you can open a Lean file in the repository (for
--  example, `LF.lean` from the top level directory) and it will install
