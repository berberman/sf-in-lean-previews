...
attribute [autogradedProof 3] All_In
...
-- Note to developers (Jonathan Chan  @ionathanch):
--     This was originally 1000 but Lean's default recursion depth is not
--     large enough to reduce `double 50` lol
...
attribute [autogradedProof 3] beq_list_true_iff
...
attribute [autogradedProof 2] forallb_true_iff
