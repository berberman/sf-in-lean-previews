...
-- Congratulations: We've reached the end of *Logical
-- Foundations*!

-- ## Looking Back

-- We've covered quite a bit of ground. Along the way, we
...
-- The next volumes carry these ideas into programming-language
-- theory and program verification:

-- - *Type Systems* develops operational semantics and type
--   systems, including the simply typed lambda calculus and the
...
-- Both volumes build directly on the definitions and proof
-- techniques introduced here.

-- ## Resources

-- This volume also contains optional sections and exercises
-- that develop some topics further.

-- For questions about Lean, the [Lean community
-- Zulip](https://leanprover.zulipchat.com/) is an active place
-- to ask questions and discuss formalization.
...
--   gives a systematic introduction to Lean's logic and proof
--   language.
