...
--        the version of decorated programs that we wound up with is really
--        the right one -- why spend all this time writing annotations that
--        we then say are unnecessary? Seems like we could define decorated
...
--           could make this much better by introducing formal decorated
...
--
--      HIDE: A quick / optional exercise using just assignment here would
--      be good.
...
--      places. I (BCP) believe Phil (Wadler) changed some instances of the
--      former to the latter.
--
--      HIDE: MRC'20: a written explanation of each part of this would be
--      quite nice. BCP 21: Agreed!! (BCP 23: But it's kind of what's just
--      above...)
...
--      exercise builders, together with some hints on how to write
--      programs that are easier to verify
