...
--      At this point, the Rocq file provides instructions about using a
--      new directory, making sure the project is set up properly, and also
--      instructions about how to deal with the exercises. I am assuming
--      these things are being moved to Intro.lean? I am excluding them for
--      now.
...
--      cause problems with the tilde. Currently skipping them and just
--      using backticks.
