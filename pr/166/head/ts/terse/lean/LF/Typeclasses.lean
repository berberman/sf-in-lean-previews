...
-- Don't worry about the `outParam`, it's like a normal
-- paramater with a hint to Lean that helps typeclass
-- inference. The `macro_rules` and the `app_unexpander` are
-- minor technicalities for getting the syntax to work.
