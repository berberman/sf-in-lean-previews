...
--  *Logic*, the mathematical basis for software
--  engineering:
...
--  This volume also contains optional sections and
--  exercises that develop some topics further.
--
--  For questions about Lean, the [Lean community
--  Zulip](https://leanprover.zulipchat.com/) is an active
