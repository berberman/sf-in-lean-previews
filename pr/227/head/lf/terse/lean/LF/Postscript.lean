...
-- If what you've seen so far has whetted your interest, you
-- have several choices for further reading in later volumes of
-- the *Software Foundations* series. Some of these are
-- intended to be accessible to readers immediately after
