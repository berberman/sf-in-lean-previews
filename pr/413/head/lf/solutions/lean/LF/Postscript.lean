...
--  - *Type Systems* develops operational semantics and type systems,
--    including the simply typed lambda calculus and the progress and
--    preservation theorems.
--  - *Hoare Logic* introduces imperative programs and Hoare logic, a
--    framework for stating and proving correctness properties of programs
--    with mutable state.
--
...
--    Lean](https://lean-lang.org/functional_programming_in_lean/) explores
--    Lean as a programming language.
--  - [Theorem Proving in Lean
--    4](https://docs.lean-lang.org/theorem_proving_in_lean4/) gives a
--    systematic introduction to Lean's logic and proof language.
--  - [Mathematics in
