...
--  exists, you may need to prove it yourself, or you may want to rethink
--  your approach.
...
--  `addTwice`, since Lean is not doing that for us automatically. We can
--  do this using the familiar `rw` tactic.
